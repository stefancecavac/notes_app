...
const NoteViewMenu = ({ singleNote }: { singleNote: noteData }) => {
  ...
  return (
    <>
      ...
      {moveMenu && <NoteMoveMenu singleNote={singleNote} setMoveMenu={setMoveMenu} setMenuOpen={setMenuOpen}></NoteMoveMenu>}
      {createPortal(
        <div className={`${menuOpen ? " w-60  " : "w-0"}   transition-all `}>
          <div className={` ${menuOpen ? "flex flex-col " : "hidden"} slide-right text-neutral-500   gap-1     p-2 `}>
            ...
            >
              {singleNote.favourite ? (
                ...
                <>
                  ...
                  <p className="whitespace-nowrap  text-xs font-medium">Add to Favourites</p>
                </>
              )}
            </button>
            ...
            <div className="flex flex-col gap-2  mt-10">
              <p className=" py-2  font-medium  pl-3 text-neutral-400">Note Details</p>
              ...
              <p className=" text-xs font-medium  pl-3 text-neutral-600">
