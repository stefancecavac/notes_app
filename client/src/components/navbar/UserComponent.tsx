...
const UserComponent = React.memo(() => {
  ...
  return (
    <div className="dropdown hover:bg-base-300 rounded-lg hover:cursor-pointer w-fit">
      <div tabIndex={0} role="button" className="flex items-center justify-between  gap-2 m-1">
        <div className="flex items-center gap-2">
          ...
          <p className=" text-xs text-base-content font-medium w-35 truncate">{user?.email}</p>
        </div>
        <svg
